...
<template>
  <div class="inline-flex flex-wrap gap-1 rounded-xl border border-white/[0.06] bg-white/[0.03] p-1">
    <button
    ...
    >
      ...
      <span
        ...
        class="rounded-full bg-white/10 px-1.5 py-0.5 text-[0.65rem] font-semibold"
      >
        {{ tab.badge }}
      </span>
    </button>
